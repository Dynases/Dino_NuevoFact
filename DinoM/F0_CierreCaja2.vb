...
#Region "METODOS PRIVADOS"
    ...
    Public Sub CargarDetalleVentasPagos(Fecha As Date, Nrocaja As Integer)
        Try
            Dim dt As New DataTable

            dt = L_fnDetalleVentasPagos(Fecha.ToString("yyyy/MM/dd"), Nrocaja)
    ...
    Public Sub _GrabarNuevo()
        Try
            ...
            If res Then
                ...
                _UltimoRegistro()
                'Ocultando campos
                Dgv_VentasPagos.Visible = False
                LabelX16.Visible = False
                tbMontoI.Visible = False
                LabelX3.Visible = False
                tbTContado.Visible = False
                LabelX5.Visible = False
                tbTPagos.Visible = False
                LabelX17.Visible = False
                tbTIngresos.Visible = False
                LabelX18.Visible = False
                tbTEgresos.Visible = False
                LabelX10.Visible = False
                tbTotalGral.Visible = False
                LabelX12.Visible = False
                tbTDiferencia.Visible = False
        ...
        Try
            ...
            If (bandera = True) Then
                ...
                If res Then
                    ...
                    _UltimoRegistro()
                    'Ocultando campos
                    Dgv_VentasPagos.Visible = True
                    LabelX16.Visible = True
                    tbMontoI.Visible = True
                    LabelX3.Visible = True
                    tbTContado.Visible = True
                    LabelX5.Visible = True
                    tbTPagos.Visible = True
                    LabelX17.Visible = True
                    tbTIngresos.Visible = True
                    LabelX18.Visible = True
                    tbTEgresos.Visible = True
                    LabelX10.Visible = True
                    tbTotalGral.Visible = True
                    LabelX12.Visible = True
                    tbTDiferencia.Visible = True
    ...
    Public Sub _prMostrarRegistro(_N As Integer)
        Try
            ...
            With Dgv_Buscador
                ...
                'tbMontoI.Value = .GetValue("ccMInicial") + Convert.ToDouble(IIf(tbObservacion.Text = "", 0, tbObservacion.Text))
...
#Region "EVENTOS"
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        If (TbCodigo.Text = String.Empty) Then
            Dim DtVerificar As DataTable = L_fnVerificarCajaAbierta(gs_NroCaja)
            If DtVerificar.Rows.Count > 0 Then
                Dim img As Bitmap = New Bitmap(My.Resources.mensaje, 50, 50)
